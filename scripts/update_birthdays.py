...
BRAND_OVERRIDES = {
    ...
    # 765プロ最初期12名は765million.ics上は "ml" 扱いになるが、
    # サイト全体の記事・ランキングでは as765 で統一されているため上書きする
    "天海春香": "as765",
    "如月千早": "as765",
    "星井美希": "as765",
    "萩原雪歩": "as765",
    ...
    "田中琴葉": "as765",
    "松田亜利沙": "as765",
    # 876プロダクション／vα-liv所属キャラは共通ICS上では"sogo"扱いになるが、
    # サイト全体の記事・ランキングでは valiv で統一されているため上書きする
    "上水流宇宙": "valiv",
    "灯里愛夏": "valiv",
}
